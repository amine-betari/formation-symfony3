...
namespace OC\UserBundle\Redirection;
    ...
    */
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
	{
		...
		elseif (in_array('ROLE_ADMIN', $rolesTab, true))
			$redirection = new RedirectResponse($this->router->generate('amine_homepage'));
		else
			$redirection = new RedirectResponse($this->router->generate('oc_platform'));
		return $redirection;
    }
}